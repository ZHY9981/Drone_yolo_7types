...
which is suitable for offline analysis but may require further optimization for onboard
drone deployment (target: <10 ms on edge hardware). TensorRT quantization is planned.
